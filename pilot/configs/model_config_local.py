...
LLM_MODEL_CONFIG = {
    ...
    "baichuan2-13b": os.path.join(MODEL_PATH, "baichuan2-13b"),
    "chatglm2-6b": os.path.join(MODEL_PATH, "chatglm2-6b"),
...
EMBEDDING_MODEL_CONFIG = {
    ...
    "text2vec": os.path.join(MODEL_PATH, "text2vec-bge-large-chinese"),
    "m3e-large": os.path.join(MODEL_PATH, "m3e-large"),
    "bge-large-zh": os.path.join(MODEL_PATH, "bge-large-zh-v1.5"),
}
